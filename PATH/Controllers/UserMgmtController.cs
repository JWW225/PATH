...
namespace ProvalusApplicantTrackingHub.Controllers
{
    public class UserMgmtController : Controller
    {
        ...
        // GET: UsersMgmt/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: UsersMgmt/Create
